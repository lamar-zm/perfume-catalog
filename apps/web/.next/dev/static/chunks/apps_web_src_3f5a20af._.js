...
"[project]/apps/web/src/app/admin/layout.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const navLinks = [
    ...
    },
    {
        href: '/admin/perfumes',
        label: 'العطور',
        icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tabler$2f$icons$2d$react$2f$dist$2f$esm$2f$icons$2f$IconBottle$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__IconBottle$3e$__["IconBottle"]
    },
    {
        ...
        "AdminLayout.useEffect": ()=>{
            const checkAuth = {
                "AdminLayout.useEffect.checkAuth": async ()=>{
                    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].getCurrentUser();
...
_s(AdminLayout, "hZY0oJkz6U7w3Nm2F2mzSKYMsOY=", false, function() {
    return [
...
//# sourceMappingURL=apps_web_src_3f5a20af._.js.map