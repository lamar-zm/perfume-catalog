...
"[project]/apps/web/src/app/api/categories/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        let category = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$services$2f$categoryService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["categoryService"].getById(id) || __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$services$2f$categoryService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["categoryService"].getBySlug(id);
        if (!category) {
        ...
        if (searchParams.get('perfumes') === 'true') {
            ...
            const perfumes = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$services$2f$perfumeService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["perfumeService"].getByCategory(category.id, {
                page,
                pageSize
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PUT(request, { params }) {
    try {
        ...
        const existing = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$services$2f$categoryService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["categoryService"].getById(id);
        if (!existing) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'التصنيف غير موجود'
        ...
        if (body.slug && body.slug !== existing.slug) {
            const slugExists = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$services$2f$categoryService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["categoryService"].getBySlug(body.slug);
            if (slugExists) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    success: false,
        ...
        const updated = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$services$2f$categoryService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["categoryService"].update(id, body);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: updated,
...
async function DELETE(request, { params }) {
    try {
        const { id } = await params;
        const deleted = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$services$2f$categoryService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["categoryService"].delete(id);
        if (!deleted) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'التصنيف غير موجود'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__726918ab._.js.map