...
async function GET(request) {
    try {
        ...
        if (endpoint === 'featured') {
            const limit = parseInt(searchParams.get('limit') || '8');
            const data = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$services$2f$perfumeService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["perfumeService"].getFeatured(limit);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
                data
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__344cca6a._.js.map