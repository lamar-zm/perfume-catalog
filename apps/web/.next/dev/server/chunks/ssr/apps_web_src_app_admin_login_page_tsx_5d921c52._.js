module.exports = [
"[project]/apps/web/src/app/admin/login/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminLoginPage() {
    ...
    const form = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$form$2f$esm$2f$use$2d$form$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useForm"])({
        ...
        validate: {
            ...
            password: (value)=>value.length >= 6 ? null : 'كلمة المرور يجب أن تكون 6 أحرف على الأقل'
        }
    });
    const handleSubmit = async (values)=>{
        ...
        setError(null);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authApi"].signIn(values.email, values.password);
            if (res.success) {
...
//# sourceMappingURL=apps_web_src_app_admin_login_page_tsx_5d921c52._.js.map