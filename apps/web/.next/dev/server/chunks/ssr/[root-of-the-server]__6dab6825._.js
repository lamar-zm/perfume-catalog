module.exports = [
"[project]/apps/web/src/data/perfumes.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/services/perfumeService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$perfumes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/data/perfumes.ts [app-ssr] (ecmascript)");
;
// ============================================
...
const perfumeService = {
   ...
   */ async getAll (pagination, filters, sort) {
        ...
        let data = [
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$perfumes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["perfumes"]
        ];
        if (filters) {
   ...
   */ async getById (id) {
        ...
        const perfume = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$perfumes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["perfumes"].find((p)=>p.id === id);
   ...
   */ async getFeatured (limit = 8) {
        ...
        const featured = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$perfumes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["perfumes"].filter((p)=>p.isFeatured);
   ...
   */ async getDiscounted (limit) {
        // TODO: Replace with Firebase Firestore query
        // where('discount', '>', 0)
        const discounted = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$perfumes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["perfumes"].filter((p)=>p.discount && p.discount > 0);
   ...
   */ async getByCategory (categoryId, pagination) {
        ...
        const filtered = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$perfumes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["perfumes"].filter((p)=>p.categoryId === categoryId);
   ...
   */ async getRelated (perfumeId, categoryId, limit = 4) {
        // TODO: Replace with Firebase Firestore query
        const related = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$perfumes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["perfumes"].filter((p)=>p.categoryId === categoryId && p.id !== perfumeId).slice(0, limit);
   ...
   */ async create (data) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$perfumes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["perfumes"].push(newPerfume);
   ...
   */ async update (id, data) {
        ...
        //   updatedAt: serverTimestamp(),
        // });
        const index = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$perfumes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["perfumes"].findIndex((p)=>p.id === id);
        if (index === -1) return Promise.resolve(null);
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$perfumes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["perfumes"][index] = {
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$perfumes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["perfumes"][index],
            ...data,
            updatedAt: new Date().toISOString()
        };
        return Promise.resolve(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$perfumes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["perfumes"][index]);
    },
    /**
   ...
   */ async delete (id) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$perfumes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["perfumes"].splice(index, 1);
   ...
   */ async search (query, pagination) {
        ...
        const filtered = applyFilters(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$perfumes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["perfumes"], {
            search: query
        });
        return Promise.resolve(paginate(filtered, pagination));
    }
...
"[project]/apps/web/src/data/categories.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/services/categoryService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$categories$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/data/categories.ts [app-ssr] (ecmascript)");
;
const categoryService = {
   ...
   */ async getAll () {
        ...
        return Promise.resolve([
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$categories$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["categories"]
        ]);
    },
    /**
   * Get category by ID
   */ async getById (id) {
        ...
        const category = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$categories$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["categories"].find((c)=>c.id === id);
   ...
   */ async getBySlug (slug) {
        ...
        const category = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$categories$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["categories"].find((c)=>c.slug === slug);
        return Promise.resolve(category || null);
    },
    /**
   ...
   */ async create (data) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$categories$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["categories"].push(newCategory);
   ...
   */ async update (id, data) {
        ...
        const index = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$categories$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["categories"].findIndex((c)=>c.id === id);
        if (index === -1) return Promise.resolve(null);
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$categories$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["categories"][index] = {
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$categories$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["categories"][index],
            ...data
        };
        return Promise.resolve(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$categories$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["categories"][index]);
    },
    /**
   ...
   */ async delete (id) {
        ...
        const index = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$categories$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["categories"].findIndex((c)=>c.id === id);
        if (index === -1) return Promise.resolve(false);
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$data$2f$categories$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["categories"].splice(index, 1);
        return Promise.resolve(true);
    }
};
}),
"[project]/apps/web/src/services/authService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/services/imageService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/services/index.ts [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$services$2f$perfumeService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/services/perfumeService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$services$2f$categoryService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/services/categoryService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/services/authService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$services$2f$imageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/services/imageService.ts [app-ssr] (ecmascript)");
;
;
;
;
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$core$2f$esm$2f$components$2f$Card$2f$Card$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"].Section, {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$core$2f$esm$2f$components$2f$Image$2f$Image$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Image"], {
                        src: perfume.image || __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$services$2f$imageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["imageService"].getPlaceholder(),
                        alt: perfume.title,
                        height: 220,
                        fallbackSrc: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$services$2f$imageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["imageService"].getPlaceholder()
                    }, void 0, false, {
...
function CategoryCard({ category }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$core$2f$esm$2f$components$2f$Card$2f$Card$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$core$2f$esm$2f$core$2f$Box$2f$Box$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Box"], {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$core$2f$esm$2f$components$2f$Image$2f$Image$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Image"], {
                    src: category.image || __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$services$2f$imageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["imageService"].getPlaceholder(400, 300),
                    alt: category.name,
                    height: 200,
                    fallbackSrc: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$services$2f$imageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["imageService"].getPlaceholder(400, 300)
                }, void 0, false, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6dab6825._.js.map