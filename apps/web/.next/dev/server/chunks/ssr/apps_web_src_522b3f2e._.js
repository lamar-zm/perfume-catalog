...
"[project]/apps/web/src/app/admin/featured/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminMostSoldPage() {
    ...
    const [toggling, setToggling] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const loadData = async ()=>{
        ...
        try {
            const [perfumesRes, catsRes] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["perfumeApi"].getAllForMostSoldAdmin(),
    ...
    const handleToggleMostSold = async (perfumeId)=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["perfumeApi"].toggleMostSold(perfumeId);
            if (res.success) {
                // Update local state
...
//# sourceMappingURL=apps_web_src_522b3f2e._.js.map