...
const perfumeService = {
    ...
    create (data) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare(`
      INSERT INTO perfumes (id, title, description, price, discount, final_price, category_id, brand_id, is_featured, sales_count, created_at, updated_at)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(id, data.title, data.description, data.price, data.discount || 0, finalPrice, data.categoryId || null, data.brandId || null, data.isFeatured ? 1 : 0, data.salesCount || 0, now, now);
        // Save images
    ...
    update (id, data) {
      ...
      SET title = ?, description = ?, price = ?, discount = ?, final_price = ?, 
          category_id = ?, brand_id = ?, is_featured = ?, sales_count = ?, updated_at = ?
      WHERE id = ?
    `).run(data.title ?? existing.title, data.description ?? existing.description, price, discount, finalPrice, (data.categoryId ?? existing.categoryId) || null, (data.brandId ?? existing.brandId) || null, data.isFeatured ?? existing.isFeatured ? 1 : 0, data.salesCount ?? existing.salesCount, now, id);
...
async function GET(request) {
    try {
        ...
        if (paginated) {
            ...
            const result = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$services$2f$categoryService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["categoryService"].getPaginated({
                page,
                pageSize
            });
        ...
        const categories = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$services$2f$categoryService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["categoryService"].getAll();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: categories
        });
...
async function POST(request) {
    try {
        ...
        const existing = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$services$2f$categoryService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["categoryService"].getBySlug(body.slug);
        if (existing) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        const category = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$src$2f$services$2f$categoryService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["categoryService"].create({
            name: body.name,
            slug: body.slug,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6383ba67._.js.map