...
;
;
// Absolute path to the production DB
const dbPath = process.env.DATABASE_PATH ?? '/var/www/perfume-catalog/data/perfume-catalog.db';
// Ensure the folder exists
const folder = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].dirname(dbPath);
if (!__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(folder)) {
    __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].mkdirSync(folder, {
        recursive: true
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a080f7a9._.js.map